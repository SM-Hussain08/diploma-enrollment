// ===============================
// UserInfoPage.jsx
// Admin UI for managing "User Information" form questions
...
export default function UserInfoPage() {
  ...
  // State Management
  // -------------------------------
  const [questions, setQuestions] = useState([]); // All user info questions
  ...
  async function saveAllChanges() {
    ...
    try {
      await updateDoc(doc(db, "formConfig", "mainConfig"), {
        "sections.userInfo.questions": questions,
      });
    } catch (err) {
      alert("Save failed");
    } finally {
      ...
      <header className={`mgmt-header-premium ${scrolled ? "is-scrolled" : ""}`}>
        <div className="header-inner">
          ...
          <div className="brand-stack">
            <h1>Participant Segment</h1>
            <h2>Manage questions for participant sention from here.</h2>
